...
public:
    ...
    void setupUi(QDialog *Login)
    {
        ...
        verticalSpacer_3 = new QSpacerItem(20, 30, QSizePolicy::Fixed, QSizePolicy::Minimum);
...
"color: rgb(255, 255, 255);"));
        ...
        reg_surepwd->setEchoMode(QLineEdit::Normal);
        ...
        reg_pwd->setEchoMode(QLineEdit::Normal);
...
"color: rgb(255, 255, 255);"));
        ...
        verticalSpacer_8 = new QSpacerItem(20, 25, QSizePolicy::Fixed, QSizePolicy::Minimum);
